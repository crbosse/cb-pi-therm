...
module.exports = function(homebridge) {
  ...
  homebridge.registerAccessory('cb-pi-therm', 'Thermostat', Thermostat);
};
...
class Thermostat {
  constructor(log, config) {
    ...
    // add relay pin
    this.heatRelayPin2 = config.heatRelayPin || 18;
    //
    ...
    HeatingCoolingStateToRelayPin = {
      ...
      // Sounds right
      [Characteristic.CurrentHeatingCoolingState.HEAT]: this.heatRelayPin2,
    ...
    // here too
    gpio.setup(this.heatRelayPin2, gpio.DIR_HIGH);
    gpio.setup(this.coolRelay
